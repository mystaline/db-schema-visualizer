...
function topoSort(tables: SchemaTable[], foreignKeys: ForeignKey[]): { sorted: SchemaTable[]; hasCycle: boolean; cycleNames: string[] } {
...
export function buildDrizzleSchema(tables: SchemaTable[], foreignKeys: ForeignKey[]): DrizzleResult {
